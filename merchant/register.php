            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                <div class="brand-logo">
                  <img src="assets/images/DelishGo Logo Ng.jpg" alt="logo">
                </div>
                <h4>New here?</h4>
                ...
                <form class="pt-3">
                  ...
                  <div class="text-center mt-4 fw-light"> Already have an account? <a href="index.html" class="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
