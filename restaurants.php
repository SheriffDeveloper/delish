...
$userEmail = $_SESSION['user_email']; // ✅ Now you can use this in restaurants.php
...
<
  ...
  <div class="nav">
    ...
    <div><a href="orders.php?user_id=' . urlencode($id) . '" style="text-decoration: none; color: inherit;"><i class="fas fa-location-arrow tracker-icon"></i>Orders</a></div>
